            ...
            <img alt='the face of the moon' src={moonFace} className='moon-face' />
              <blockquote className='dialog-container'>
                ...
                <Route exact path='/lunares/3'>
                  <h1 className='dialog'>You have three. Remember nothing is for free</h1>
                </Route>
                ...
                <Route exact path='/lunares/7'>
                  <h1 className='dialog'>And now you're closer to the end than you are to the start</h1>
                </Route>
                ...
                <Route exact path='/lunares/11'>
                  <h1 className='dialog'>See how far curiousity and faith has brought you?</h1>
                </Route>
